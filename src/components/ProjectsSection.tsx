    ...
    <section id="projects" className="py-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          {/* Paragraph */}
          <BlurText
            text="A showcase of my development work and technical expertise"
            delay={160}
            animateBy="words"
            direction="top"
          ...
          {projects.map((project, index) => {
            ...
            return (
              <Card
                ...
                className={`hover-elevate transition-all duration-300 h-full flex flex-col border-card-border ${isVisible ? 'animate__animated animate__zoomIn' : 'opacity-0'
                  }`}
